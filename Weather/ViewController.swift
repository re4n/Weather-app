...
class ViewController: UIViewController {
    ...
    private var infoCity = City(lat: "13.736717", lon: "100.523186", name: "Bangkok")
    ...
    private func loadData(){
        ...
        if forecastResponse?.current.dt.isDayTime() ?? true {
            backgroundView.image = UIImage(named:"bg-day")
        } else {
            backgroundView.image = UIImage(named: "bg-night")
        }
